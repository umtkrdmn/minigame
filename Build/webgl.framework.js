...
var ASM_CONSTS = {
  5458908: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5458963: function($0) {performance.now = function() { return $0; };},  
 5459011: function($0) {performance.now = function() { return $0; };},  
 5459059: function() {performance.now = Module['emscripten_get_now_backup'];},  
 5459114: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5459175: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5459239: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _SetToLocalStorage(key, value) {
  ...
  function _emscripten_resize_heap(requestedSize) {
      ...
      for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
        var overGrownHeapSize = oldSize * (1 + 7.86 / cutDown); // ensure geometric growth
  ...
  function _isMouseOnPlayArea(){
    return document.isMouseInsideGameWindow;
    }
  ...
  function _setOnMouseEnterExitEvents(){
    document.isMouseInsideGameWindow = false;
  	document.getElementById('unity-container').addEventListener('mouseenter', function() {
    document.isMouseInsideGameWindow = true;
          });
  	document.getElementById('unity-container').addEventListener('mouseleave', function() {
     document.isMouseInsideGameWindow = false;
          });
    }
...
var asmLibraryArg = {
  ...
  "isMouseOnPlayArea": _isMouseOnPlayArea,
  "llvm_eh_typeid_for": _llvm_eh_typeid_for,
  "setOnMouseEnterExitEvents": _setOnMouseEnterExitEvents,
